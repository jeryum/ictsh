...
function getMealFlag(mealName) {
  ...
  const flags = {
    "New York Cheesecake":
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Flag_of_New_York.svg/1200px-Flag_of_New_York.svg.png",
    "French Toast":
  ...
  return (
    flags[mealName] ||
    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Flag_of_the_United_States.svg/1280px-Flag_of_the_United_States.svg.png"
  ); // Default flag
}
